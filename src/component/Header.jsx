...
const Header = () => {
  ...
  return (
    <>
    <Button pos={'fixed'} top={'4'} left={'4'} colorScheme={'purple'} p={'0'} padding={'0'} w={'10'} h={'10'} borderRadius={'full'} onClick={onOpen} zIndex={'overlay'} ><BiMenuAltLeft size={'20'} /></Button>
    ...
    <DrawerContent>
      <DrawerCloseButton />
      <DrawerHeader>PLAY HUB</DrawerHeader>
      <DrawerBody>
