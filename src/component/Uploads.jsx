...
const Uploads = () => {
  return <Container maxW={'container.xl'} h='100vh' p={'16'}>
    ...
    <VStack color={'purple.500'} h='full' justifyContent={'center'}>
        ...
        <form >
            <HStack>
                <Input required type={'file'} css={{'&::file-selector-button':{border:'none',width:'calc(100% + 36px)',height:'100%',marginLeft:'-18px', color:'purple', backgroundColor:'white', cursor:'pointer'}}}  />
